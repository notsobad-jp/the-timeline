  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 z-50">
        <div className="flex flex-col bg-black text-white w-10 mt-32 mr-6 rounded divide-y divide-gray-600">
          <div onClick={() => zoom(0.7) } className="w-full">
          ...
          <div onClick={() => move(0.3) } className="w-full">
            <div className="p-2 fill-current">
              <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></svg>
            </div>
          </div>
          <div onClick={() => move(-0.3) } className="w-full">
            <div className="p-2 fill-current">
              <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></svg>
            </div>
          </div>
          <div onClick={fit} className="w-full">
            <div className="p-2 fill-current">
