        ...
        <div className="bg-gray-900 w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
          <div className="relative py-6 text-left px-6">
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row mb-10">
                <a className="flex items-center mb-3 md:mb-0 md:w-2/4 md:mr-1 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded" href={`https://twitter.com/intent/tweet?hashtags=the_timeline&text=${title}%20-%20年表作成サービス「THE%20TIMELINE」&url=${canonicalUrl}`} target="_blank">
                ...
                <a className="flex items-center md:w-2/4 md:ml-1 bg-blue-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href={`https://www.facebook.com/sharer/sharer.php?u=${canonicalUrl}`} target="_blank">
                  <svg className="fill-current text-white mr-2" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
