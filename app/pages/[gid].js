...
export default function Index({title, data}) {
  ...
  return (
    <>
      <div className="bg-gray-900 px-4 py-2 text-white flex fixed w-full z-50">
        <h1>
        ...
        <div className="flex-grow text-right">
          <div className="inline-block w-4 h-4 fill-current ml-4 align-middle cursor-pointer hover:opacity-75">
            <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM8 20H4v-4h4v4zm0-6H4v-4h4v4zm0-6H4V4h4v4zm6 12h-4v-4h4v4zm0-6h-4v-4h4v4zm0-6h-4V4h4v4zm6 12h-4v-4h4v4zm0-6h-4v-4h4v4zm0-6h-4V4h4v4z"></path></svg>
          </div>
          <div className="inline-block w-4 h-4 fill-current ml-4 align-middle cursor-pointer hover:opacity-75">
      ...
      { data.items.length == 0 &&
        <div className="absolute top-0 mt-12 w-full z-50">
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mx-2" role="alert">
